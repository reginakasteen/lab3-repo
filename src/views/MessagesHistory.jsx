            ...
            <div className="border-b-2 border-dashed border-gray-400 py-2 px-4">
              <div className="flex items-center py-1">
                <div className="relative">
                  <img
                    src={interlocutor.photo || 'https://chat-back-production-1153.up.railway.app/static/default_image.jpg'}
                ...
                <div className="pl-3 flex-grow">
                  <Link to={`/user/${id}/`}>{interlocutor?.name || "Unknown"}</Link>
                ...
                history.map((message, index) => (
                  ...
                  >
                    {message.sender !== user_id && (
                      <img
                        src={message.sender_profile?.photo || 'https://chat-back-production-1153.up.railway.app/static/default_image.jpg'}
                    ...
                    >
                      <div className="font-semibold">
                        {message.sender === user_id ? "You" : message.sender_profile?.name || "Unknown"}
                      </div>
                      {message.message}
